...
function buscarEnderecoPorCEP(cep) {
    ...
    if (cep.length !== 8) {alert("Insira um CEP com 8 digitos.");return;}
    ...
    fetch(`https://viacep.com.br/ws/${cep}/json/`)
      ...
      .then(data => {
        ...
        document.getElementById('signup-logradouro').value = data.logradouro || '';
        document.getElementById('signup-bairro').value = data.bairro || '';
        document.getElementById('signup-cidade').value = data.localidade || '';
        document.getElementById('signup-estado').value = data.uf || '';
      })
      .catch(error => {
